...
const FilterBar: React.FC<FilterBarProps> = ({
  ...
  const selectClasses = "appearance-none bg-transparent border-0 text-gray-900 dark:text-dark-text-primary text-sm font-medium focus:outline-none focus:ring-0 block w-full pl-3 pr-8 py-2 transition-colors";

  return (
    <div className="flex flex-col sm:flex-row flex-wrap items-center gap-4">
      <div className="flex items-center text-gray-500 dark:text-dark-text-secondary font-medium shrink-0">
        <AdjustmentsHorizontalIcon className="h-5 w-5 mr-2" />
        <span className="text-sm font-semibold">Filters</span>
      </div>

      {/* SEAMLESS FILTER GROUP */}
      <div className="flex items-center bg-gray-200 dark:bg-dark-card rounded-lg divide-x divide-gray-300 dark:divide-dark-border ring-1 ring-gray-300/50 dark:ring-dark-border focus-within:ring-2 focus-within:ring-blue">
      ...
      <div className="sm:ml-auto flex items-center gap-4">
        <div className="flex items-center">
          <input
            ...
            className="w-4 h-4 text-blue bg-gray-100 border-gray-300 rounded focus:ring-blue dark:bg-dark-bg dark:border-dark-border"
          />
          <label htmlFor="my-function-toggle" className="ml-2 text-sm font-medium text-gray-900 dark:text-dark-text-primary">
            My Functions Only
          </label>
        </div>

        <div className="flex items-center text-gray-500 dark:text-dark-text-secondary font-medium">
          <ArrowsUpDownIcon className="h-5 w-5 mr-1" />
          <div className="flex items-center bg-gray-200 dark:bg-dark-card rounded-lg ring-1 ring-gray-300/50 dark:ring-dark-border focus-within:ring-2 focus-within:ring-blue">
            <div className={selectWrapperClasses}>
